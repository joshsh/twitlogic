...
public interface SIOC {
    ...
    public static final String
            ...
            ADDRESSED_TO = NAMESPACE + "addressed_to",
            ...
            ITEM = NAMESPACE + "Item",
            LAST_ACTIVITY_DATE = NAMESPACE + "last_activity_date",
            LAST_ITEM_DATE = NAMESPACE + "last_item_date",
            ...
            NOTE = NAMESPACE + "note",
            NUM_AUTHORS = NAMESPACE + "num_authors",
            NUM_ITEMS = NAMESPACE + "num_items",
            NUM_REPLIES = NAMESPACE + "num_replies",
            NUM_THREADS = NAMESPACE + "num_threads",
